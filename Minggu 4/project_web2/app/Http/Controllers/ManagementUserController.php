...
class ManagementUserController extends Controller
{
    ...
    public function store(Request $request){
        return "Method ini nantinya akan digunaka untuk menciptakan data user yang baru";
    }

    public function show($id){
        return "Method ini nantinya akan digunakan menampilkan form untuk mengubah data edit dengan id=" . $id;
    }
